// The Common Paper Mutual NDA Standard Terms (Version 1.0), embedded verbatim
// from templates/mutual-nda.md. The `<span class="coverpage_link">…</span>`
// markers in the source simply flagged defined terms (Purpose, Effective Date,
// etc.); here they are plain words, since the Cover Page supplies their values.
